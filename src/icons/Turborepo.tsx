...
export function Turborepo({ multicolor = true }: { multicolor?: boolean }) {
  const color = useIconColor('#EF4444', multicolor);
  return (
    <svg
