...
export interface TurborepoIconProps extends SVGProps<SVGSVGElement> {
  multicolor?: boolean;
}
...
export function TurborepoIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <title>Turborepo-icon SVG Icon</title>
      {multicolor && (
        <defs>
          <linearGradient
            id="logosTurborepoIcon0"
            x1="123.779%"
            x2="123.779%"
            y1="0%"
            y2="698.962%"
